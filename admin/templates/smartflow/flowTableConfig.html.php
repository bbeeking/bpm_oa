  ...
  <div class="form_content">
    <table class="table table-striped table-bordered mediaTable" id="TableId">
      ...
      <tbody id="formInfoId">
        <tr>
          <td>
            {get_section('template0',$templateDefineAry ,'',$ary_first=array(''),'template0','','width:180px;',$etc='data-placeholder="请选择..."')}
          </td>
          <td>
            {get_section('readWrite0',$readWriteConfigAry ,'',$ary_first=array(),'readWrite0','','width:60px;',$etc='data-placeholder="请选择..."')}
          </td>
          <td>
...
<script type="text/javascript">
  ...
  function additem(id){
    ...
    if (row != null){
      ...
      var section = '{get_return_section('template',$templateDefineAry ,'',$ary_first=array(''),'template','','width:180px;',$etc='data-placeholder="请选择..."')}';
      section = section.replace(/template/g, "template"+count);
      cell0.innerHTML = section;

      var section = '{get_return_section('readWrite',$readWriteConfigAry ,'',$ary_first=array(),'readWrite','','width:60px;',$etc='data-placeholder="请选择..."')}';
