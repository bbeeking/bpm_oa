                    ...
                    <table class="table table-striped table-bordered mediaTable" id="dt_d">
                        <thead>
                            <tr>
                                ...
                                <th class="optional">{L("类型")}</th>
                                <th class="optional">{L("分类")}</th>
                                <th class="optional">{L("有效")}</th>
                                <th class="optional">{L("debug")}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{$val['id']}</td>
                                <td><a href="../procedure/procedureRun.php?pid={$val['id']}">{$val['process_title']}</td>
                                <td>{$val['type']}</td>
                                <td>{$val['category']}</td>
                                <td>{$enabledConfigAry[$val['status']]}</td>
                                <td>{$enabledConfigAry[$val['debug']]}</td>
                                <td>{$realNameAry[$val['builder']]}</td>
                                <td>{date('Y-m-d H:i:s',$val['create_time'])}</td>
                                <td>
                                    <a href="#" onclick="javascript:window.location = 'flowAdd.php?id={$val['id']}'">编辑属性</a> |
                                    <a href="#" onclick="javascript:window.location = 'processDesigner.php?id={$val['id']}'">设计</a>
                                </td>
                            </tr>
                            {/loop}
                        </tbody>
