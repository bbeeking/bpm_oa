									...
									<fieldset>
										...
										<div class="control-group formSep">
											...
											<div class="controls">
												...
												{get_section('pid',$projectAry,$pid,$ary_first=array(''),'pid','','',$etc='data-placeholder="请选择归属项目..."')}
											</div>
										</div>
										<div class="control-group formSep">
											...
											<div class="controls">
<!--												{get_section('status',$jobStatus,$status,$ary_first=array(''),'status')}-->
												{get_section('status',$jobStatus,$status,$ary_first=array(''),'status','','',$etc='data-placeholder="请填写任务状态..."')}
											</div>
										</div>
										<div class="control-group formSep">
											<label for="username" class="control-label"><span class="f_req">*</span>优先级</label>
											<div class="controls">
												{get_section('priority',$priorityStatusAry,$priority,$ary_first=array(''),'priority','','',$etc='data-placeholder="紧急为优先处理..."')}
											</div>
										</div>
										<div class="control-group formSep">
											<label for="username" class="control-label"><span class="f_req">*</span>指派给</label>
											<div class="controls">
												{get_section('performer',$userAllowAry,$performer,$ary_first=array(''),'performer')}
											</div>
										</div>
										<div class="control-group formSep">
										...
										<div class="control-group formSep">
											...
											<div class="controls">
												<input type="text" class="" id="dp1" name="startDate" value="{$startDate}" data-date-format="yyyy-mm-dd" />
											</div>
										</div>
										<div class="control-group formSep">
											<label for="username" class="control-label"><span class="f_req">*</span>计划完成日期</label>
											<div class="controls">
												<input type="text" class="" id="dp2" name="endDate" value="{$endDate}" data-date-format="yyyy-mm-dd" />
											</div>
										</div>
										<div class="control-group formSep">
										...
										<div class="control-group formSep">
											...
											<div class="controls">
												<div class="jstEditor">
										    		<textarea cols="60" rows="10" style="height:150px;width:80%;" name="myEditor" id="myEditor">{$content}</textarea>
											    </div>
