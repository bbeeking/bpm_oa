...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a class="brand" style="width:220px;" href="{DAEM_PATH}admin/index.php"><!--<i class="icon-home icon-white"></i>--> <i><img src="{DAEM_PATH}admin/templates/icon.png" width="28px"></i> {WEBTITLE}</a>
            <ul class="nav user_menu pull-right">
                <li class="hidden-phone hidden-tablet">
                    <div class="nb_boxes clearfix">
                        ...
                        <a data-toggle="modal" data-backdrop="static" href="#myTasks" class="label ttip_b" title="未完成任务" id="fuck">{count($myUndoJobAry)} <i class="splashy-calendar_week"></i></a>
                    </div>
                </li>
                <li class="divider-vertical hidden-phone hidden-tablet"></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">{$userAry[$_SESSION['UserName']]} <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                    <li><a href="user_profile.html">账户信息</a></li>
                    <li><a href="javascrip:void(0)">其他</a></li>
                    <li class="divider"></li>

<!--                    <li><a href="{DAEM_PATH}admin/logout.php">登出</a></li>-->
                        {if get_visit_uri()=='index.php' || get_visit_uri()==''}
                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{DAEM_PATH}data/doc/珠海星弘科技EBPM简介.pdf">EBPM平台产品白皮书</a></li>
                                <li><a href="{DAEM_PATH}data/doc/EBPM用户手册.docx">EBPM用户手册</a></li>
                            </ul>
                        </li>
                        <!-- 
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{DAEM_PATH}../pms_v1/admin/index.php" title="兼容ie6等旧版浏览器">极速版v1.0.1</a></li>
                        ...
                        <li class="dropdown">
                         ...
                         -->
                        <li>
                            <a href="{DAEM_PATH}/changelog.txt"><i class="icon-book icon-white"></i>  更新信息</a>
                        </li>
                    </ul>
                </div>
            </nav>
