...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"抱歉!未能搜索到相关数据",sInfo:"当前显示 _START_ 至 _END_ 条记录,合计 _TOTAL_ 条记录",sInfoEmpty:"当前显示 0 至 0 条记录,合计 0 条记录",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"每页显示 _MENU_ 条记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"快速查找:",sUrl:"",sZeroRecords:"没有找到相关记录"},
