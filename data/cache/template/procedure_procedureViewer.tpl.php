                                    ...
                                    for($j=0;$j<count($val[$i]);$j++)
                                    {
                                        ...
                                        if($val[$i][$j]["type"]!= 'title')
                                        {
                                            ...
                                            if(count($val[$i]) == 1)
                                            {
                                                ...
                                                if(isset($elementTypeConfigAry[$val[$i][$j]["type"]]))
                                                {
                                                    echo "<td colspan='".($maxCountNum-1)."'>".$formElementConfigAry[$val[$i][$j]["formElement"]][$formDataAry[$val[$i][$j]["param"]]]."</td>";
                                                }
                                                //2018-01-23 判断是否文件/附件类型
                                                elseif($val[$i][$j]["type"] == "file")
                                                {
                                                    echo "<td colspan='".($maxCountNum-1)."'><a href=\"".DAEM_PATH.$formDataAry[$val[$i][$j]["param"]]["path"]."\">".$formDataAry[$val[$i][$j]["param"]]["fileName"]."</a></td>";
                                                }
                                                ...
                                                {
                                                    echo "<td colspan='".($maxCountNum-1)."'>".$formDataAry[$val[$i][$j]["param"]]."</td>";
                                                }
                                            }
                                            else
                                            {
                                                //自定义表单元素类型，需要加入枚举配置替换值
                                                if(isset($elementTypeConfigAry[$val[$i][$j]["type"]]))
                                                {
                                                    echo "<td>" . $formElementConfigAry[$val[$i][$j]["formElement"]][$formDataAry[$val[$i][$j]["param"]]] . "</td>";
                                                }
                                                //2018-01-23 判断是否文件/附件类型
                                                elseif($val[$i][$j]["type"] == "file")
                                                {
                                                    echo "<td><a href=\"".DAEM_PATH.$formDataAry[$val[$i][$j]["param"]]["path"]."\">".$formDataAry[$val[$i][$j]["param"]]["fileName"]."</a></td>";
                                                }
                                                elseif($val[$i][$j]["type"] == "image")
                                                {
                                                    echo "<td>
                                                ...
                                                {
                                                    echo "<td>" . $formDataAry[$val[$i][$j]["param"]] . "</td>";
                                                }
                                            }
