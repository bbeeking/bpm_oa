...
<!--											<?php echo get_section('ele_table[]',$templateDefineAry ,'',$ary_first=array(''),'ele_table','','width:120px;',$etc='data-placeholder="选择关联表单..."');?>-->
<select name="ele_table[]" id="ele_table" multiple data-placeholder="选择关联表单..."  style="width:150px;" >
<?php if(is_array($templateDefineAry)) foreach($templateDefineAry AS $key=>$val) { ?>
