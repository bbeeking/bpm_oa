        ...
        <tr>
          <td style="background-color:#fff;">
            ...
            <select name="node_role" id="node_role" multiple data-placeholder="选择角色..." style="width: 580px;">
              <?php if(is_array($nodeRoleConfigAry)) foreach($nodeRoleConfigAry AS $key=>$val) { ?>
...
<?php } ?>
            ...
            <input type="hidden" name="options_value" id="options_value" value="<?php echo $options_value;?>" />
          </td>
        </tr>
      </tbody>
    </table>
