    ...
    <div id="contentwrapper">
        <div class="main_content">
            ...
            <form action="" class="form-horizontal well" enctype="multipart/form-data"  name="FormPage" id="FormPage"  method="post" >
                <fieldset>
                    <p class="f_legend"><?php echo $actName;?>元素规范</p>
                    <div class="control-group">
                        <label class="control-label">名称：<span class="f_req">*</span></label>
                        <div class="controls">
                            <input type="text" class="dfinput"  name="name" id="name" value="<?php echo $result['name'];?>" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <input type="text" class="dfinput"  name="elementPropertySign" id="elementPropertySign" value="<?php echo $result['element_property_sign'];?>" <?php if($_GET["element_property_sign"]!="") { ?>readonly="readonly"<?php } ?>  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
<!--                            <input type="text" class="dfinput" style="width:120px;margin-bottom:8px;" name="checkboxParamManual" id="checkboxParamManual" value=""  />-->
                            <input type="text" class="dfinput"  name="defaultValueConfig" id="defaultValueConfig" value="<?php echo $result['default_value_config'];?>"  />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo get_section('elementTypeOf',$elementDataTypeOfConfigAry,$result['elementTypeOf'],$ary_first=array(''),'elementTypeOf','','',$etc='data-placeholder="请选择数据类型..."');?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo get_section('elementProperty',$readWriteConfigAry,$result['elementProperty'],$ary_first='default','elementProperty','','',$etc='data-placeholder="请选择操作属性..."');?>
                            <span id="elementTypeMsg" class="help-block" style="color:#ff0000;"></span>
                        </div>
                    </div>
                    <!--
                    ...
                    <table class="table table-striped table-bordered mediaTable" id="dt_d">
                        <thead>
                            <tr>
                                ...
                                <th class="optional"><?php echo L("类型/长度");?></th>
                                <th class="optional"><?php echo L("显示");?></th>
                                <th class="optional"><?php echo L("默认值配置");?></th>
                                <th class="optional"><?php echo L("输出预览(动态)");?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $val['element_property_sign'];?></td>
                                <td><?php echo $val['name'];?></td>
                                <td><?php echo $elementDataTypeOfConfigAry[$val['elementTypeOf']];?></td>
                                <td><?php echo $readWriteConfigAry[$val['elementProperty']];?></td>
                                <td><?php echo $val['default_value_config'];?></td>
<!--                                <td>--><?php ////echo eval("return $val['default_value_config'];"); ?><!--</td>-->
<!--                                <td>--><?php //echo $_SESSION['UserName']; ?><!--</td>-->
                                ...
                                <td>
                                    <a href="?element_property_sign=<?php echo $val['element_property_sign'];?>" title="Edit"><i class="icon-pencil"></i></a>
                                    <a href="javascript:void(0)" class="del_confirm" title="Delete" id="<?php echo $val['element_property_sign'];?>"><i class="icon-trash"></i></a>
                                </td>
                            </tr>
