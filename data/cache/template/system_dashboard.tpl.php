...
<ul class="ov_boxes">
<li>
<div class="p_line_up p_canvas"><?php echo $weekStaticStr;?></div>
<div class="ov_text">
<strong><?php echo $thisWeekCount;?>条</strong>
本周提交流程
</div>
</li>
<li>
<div class="p_line_down p_canvas"><?php echo $monthStaticStr;?></div>
<div class="ov_text">
<strong><?php echo $thisMonthCount;?>条</strong>
本月提交流程
</div>
</li>
<li>
...
<div class="ov_text">
<strong><?php echo $finishCaseNum;?>/<?php echo $totalCaseNum;?></strong>
累计办结流程/总流程
</div>
</li>
<li>
