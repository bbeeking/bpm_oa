  ...
  <div class="form_content">
    <table class="table table-striped table-bordered mediaTable" id="TableId">
      ...
      <tbody id="formInfoId">
        <tr>
          <td>
            <?php echo get_section('nextTask0',$flowDataConfigAry ,'',$ary_first=array(''),'nextTask0','','',$etc='data-placeholder="请选择..."');?>
          </td>
          <td>
...
//      cell0.innerHTML = '<?php echo get_return_section('nextTask',$flowDataConfigAry ,'',$ary_first=array(''),'nextTask','','',$etc='data-placeholder="请选择..."');?>';
      var section = '<?php echo get_return_section('nextTask',$flowDataConfigAry ,'',$ary_first=array(''),'nextTask','','',$etc='data-placeholder="请选择..."');?>';
